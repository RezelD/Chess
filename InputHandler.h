        ...
        switch (piece) {
            ...
            case PieceType::blackPawn:
                ...
                if (piece == PieceType::whitePawn) {
					moveInfo.piece = PieceType::whitePawn;
                    doubleStepDest = 3;
                    direction = -1;
                }
                else {
					moveInfo.piece = PieceType::blackPawn;
					doubleStepDest = 4;
					direction = 1;
                }
                ...
                if (board.isOccupied(toSquare)) {
                    ...
                    if (pathSquare == piece) {
                        ...
                        if (lastMoveInfo.exceptions & static_cast<uint8_t>(Move::Exceptions::EN_PASSANT)) {
                            // en passant move
                        }
                    }
                    else{
